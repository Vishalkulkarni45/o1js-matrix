import { Circuit, Field, Gadgets, Bool, Provable } from "o1js";
...
export function mul_quant(x_quantized: Field, x_zero_point: Field, x_scale_reciprocal: Field, y_quantized: Field, y_zero_point: Field, y_scale_reciprocal: Field, z_zero_point: Field, z_scale_reciprocal: Field): Field {
...
// ((x_quantized - x_zero_point) / x_scale_reciprocal) / ((y_quantized - y_zero_point) / y_scale_reciprocal) * z_scale_reciprocal + z_zero_point;
export function div_quant(x_quantized: Field, x_zero_point: Field, x_scale_reciprocal: Field, y_quantized: Field, y_zero_point: Field, y_scale_reciprocal: Field, z_zero_point: Field, z_scale_reciprocal: Field): Field {
...
// ((x_quantized - x_zero_point) / x_scale_reciprocal) + ((y_quantized - y_zero_point) / y_scale_reciprocal) * z_scale_reciprocal + z_zero_point;
export function add_quant(x_quantized: Field, x_zero_point: Field, x_scale_reciprocal: Field, y_quantized: Field, y_zero_point: Field, y_scale_reciprocal: Field, z_zero_point: Field, z_scale_reciprocal: Field): Field {
    ...
    let multiplier_x_y = Provable.if(is_x_scale_gr, Field, y_scale_reciprocal.mul(Field(2)), x_scale_reciprocal.mul(Field(2)));
...
// ((x_quantized - x_zero_point) / x_scale_reciprocal) - ((y_quantized - y_zero_point) / y_scale_reciprocal) * z_scale_reciprocal + z_zero_point;
export function sub_quant(x_quantized: Field, x_zero_point: Field, x_scale_reciprocal: Field, y_quantized: Field, y_zero_point: Field, y_scale_reciprocal: Field, z_zero_point: Field, z_scale_reciprocal: Field): Field {
